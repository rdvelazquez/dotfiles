...
#set -o vi     #Disabled so I can clear the terminal with <Ctrl - l>
...
PS1="\[$CYAN\][\$TIME\\[$CYAN\]]\[$NC\] $GREEN\][\u@\h] \n\[$CYAN\] \w \[$BLA\]\[$NC\] "
;;
        linux | screen )
...
#alias database='ssh database -l rdvelazquez
#alias gateway='ssh gateway -l rdvelazquez
#alias gibbon='ssh gibbon -l rdvelazquez
#alias lemur='ssh lemur -l rdvelazquez
#alias mandrill='ssh mandrill -l rdvelazquez
#alias mb='ssh monkeybusiness -l rdvelazquez
#alias monitor='ssh monitor -l rdvelazquez
#alias silverback='ssh silverback -l rdvelazquez
#alias tamarin='ssh tamarin -l rdvelazquez
#alias yeti='ssh yeti -l rdvelazquez

#alias whereami='echo "$( hostname --fqdn ) ($(hostname -i)):$( pwd )"'
#alias stageapp='ssh stageapp -l rdvelazquez
#alias testapp='ssh testapp -l rdvelazquez
...
remember() {
  cat ~/.dotfiles/remember.txt | grep "$1"
}
